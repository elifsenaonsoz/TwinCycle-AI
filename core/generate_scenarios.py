...
try:
    from .incentive import incentive_logic
except ImportError:
    from incentive import incentive_logic
...
def assert_assess_contract(
    ...
    if scenario_name == "scenario_A":
        ...
        assert "veri silme kaygısı" in rationale.lower(), "scenario_A rationale must mention veri silme kaygısı"
...
def build_scenario_a(base: dict[str, Any]) -> dict[str, Any]:
    ...
    scenario["decision_summary"] = {
        ...
        "rationale": (
            ...
            "cihazı elde tutup batarya yenileme en dengeli yol; veri silme kaygısı etkisini "
...
def generate() -> None:
    ...
    scenario_a_input_payload = scenario_a["inputs_echo"]
    scenario_b_input_payload = scenario_b["inputs_echo"]
    incentive_a = incentive_logic(scenario_a_input_payload, "tradein_new")
    incentive_b = incentive_logic(scenario_b_input_payload, "tradein_new")
